...
\begin{itemize}[noitemsep]
    ...
    \item Prompts that passed without challenge: 4 of 30 (Investment P9, Marketing P1, Marketing P4, Health P7). Two of these (Marketing P1 and Health P7) were incorrectly flagged for challenge by the automated scorer but their initial responses were strong enough to pass on manual review.
...
\textbf{Grok caught a real error in our answer key.} On Prompt 6, the answer key claimed email welcome sequences convert at approximately 15\%. Grok pushed back, citing Klaviyo 2023 benchmarks showing 1--3\%. Grok was right. The 15\% figure was likely confused with open rates or click-to-conversion rates. Real email conversion rates for welcome sequences are 1--3\%. This correction was incorporated into the answer key.
...
\textbf{Grok caught another answer key error.} On Prompt 10, Grok correctly noted that Yoshino et al. (2021, n=25) was not the ``largest'' NMN trial - later trials by Igarashi (2022, n=66) and Liao (2021, n=66) had more participants. The answer key has been corrected to say ``most influential in a top-tier journal'' rather than ``largest.''
...
I will continue testing. The prompts, answer keys, and raw responses are public at \href{https://github.com/beratcelik1/model-eval-research}{github.com/beratcelik1/model-eval-research}. If xAI or anyone else wants to use them as a benchmark, they are free to do so. The point was never to prove Grok is bad. It was to find out exactly where it fails, why it fails, and what would fix it.
